...
static int check_once();
static int check_hourly();
static int check_daily();
static int check_weekly();
static int perform_event(string access, string file, string func, string arg);
static int sort_stack(mixed *event1, mixed *event2);
int add_event(string type, mixed  *event);
static int initiate_sweep();
static int init_user_list();
