...
static void get_name(string str, object ob, int count);
...
static void enter_world(object user)
{
	...
	if( bad_pass ) {
		tell_object( player, 
			"\nWARNING: 有人於 " + ctime(bad_pass[1]) + " 从 " + bad_pass[0] + " 尝试连线失败　\n");
