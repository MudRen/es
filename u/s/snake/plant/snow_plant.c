...
void create()
{
	set_short("@@query_c_name");    
   	...
   	set("value", ({0, "silver"}) );       // 野生的树当然不值钱啊
        ...
        set("herb_file","snow_lotus.c") ;     //提炼出来的东东的完整档名
...
string query_c_name()
{
  ...
  if (this_player()->query_stat("int") < 10 ) {
    ...
    set_long("根据你仔细鉴定的结果, 你判断这是极少见的雪莲(snow lotus),\n"
    ...
    set_long("根据你在国中生物课本中得来的知识, 你判断这是一种多年生草本植物, \n"
             "不过正确的名称, 还须要进一步的辨识。\n");
    return "多年生草本植物";
  }
}      
