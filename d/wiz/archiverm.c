// This room lets you access the board archives in /d/farwind/data/attic.
...
"various boards of this MUD.\n") ;
	set ("exits", ([ "south" : "/d/farwind/tower1" ]) ) ;
	brd=clone_object("/std/board/archive");
    brd->set_attic_dir("/d/farwind/data/attic");
 	brd->set_location("/d/farwind/archiverm") ;
}
