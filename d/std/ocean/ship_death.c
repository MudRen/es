...
int loc;
mixed *schedule = ({
	({ "Bluesand", "蓝沙港", "/d/noden/bluesand/jetty", 30, 70 }),
...
{
	return
		"这是一艘叫做黑暗商人号的破船，你如果想要搭乘黑暗商人号，可以\n"
		"用 board 指令搭船。\n"
		"黑暗商人号的下一个目的地是" + schedule[(loc+1)%sizeof(schedule)][1] + "。\n";
}
...
void announce()
{
	...
	tell_room( ship_room, 
		"黑暗商人号的水手大叫: 二十秒後开船！下一站是" + schedule[next_loc][1] + "！\n" );
	tell_room( environment(this_object()), 
		"黑暗商人号的水手大叫: 二十秒後开船！下一个目的地是" + schedule[next_loc][1] + "，要上船的旅客请赶快！\n");
	call_out( "lets_go", 20 );
}
...
void lets_go()
{
	...
	tell_room( ship_room, 
		"黑暗商人号的水手大叫: 开船罗！\n"
		"你感到船身一阵轻微的震动，黑暗商人号离开了码头 ....\n" );
	tell_room( environment(this_object()), 
		"黑暗商人号的水手大叫: 开船罗！\n"
		"黑暗商人号缓缓地开出港口，航向辽阔的大海 ....\n");
