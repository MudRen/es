...
string *c_illusion = ({
	...
	"火海....。\n",
	"淡紫色的云彩中，许多亮晶晶的透明水晶球悬浮著，远方传来阵阵的乐声....。\n",
	...
	"狰狞可怖的脸飞出来....。\n",
	"森林中许多蓝色的蝴蝶在飞舞著，然後一只燃著熊熊火焰的独角兽冲入蝴\n"
	"蝶群中....。\n",
	"两个身穿红衣的骑士在一片躺满死尸的高地上决斗，一名戴著面具的少女在\n"
	"一旁沈默地看著 ....。\n",
	"成千上万的士兵如痴如醉地狂喊著「杀呀！杀呀！」，一个被士兵包围著的\n"
	"白衣胖子脸上用不屑的眼神瞪视著这些疯狂的士兵。\n",
	"一只巨大的蓝色火龙正侧著头，倾听著一旁两名精灵少年吹奏著的长笛。\n",
	"黑夜中许多红色的身影无声无息地向一座耸立在悬崖上的城堡飘去，天空\n"
	"中正飘著细雨 .....。\n"
});
