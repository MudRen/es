...
protected int add_buffer1(string mesg);
...
//	protected global shell variables - Not retained in save file

nosave object old_room;
nosave mixed *sweep, *socket, *buff_pos;
nosave string prompt, time, dir, *buffer1, *TMP_buffer1;
protected int Status, scheck, vis, busy, HOME, help;
...
protected cursor1_colour(string str) {
   int pos;
...
protected buffer1_colour(string str) {
   int pos;
...
protected int print_buffer1(string str) {
...
protected int process_buffer1(string str) {
